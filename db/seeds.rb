...
doctors = Doctor.create([{:name => 'Natália Andrade da Costa',
	...
	patients = Patient.create([{:name => 'Francisco Silva',
			:address => 'Rua de Feliciano de Castilho, 222',
			...
			{:name => 'Paulo Sousa',
			:address => 'Avenida da Boavista, 556',
			...
			:address => 'Avenida da Boavista, 554',
			...
			{:name => 'Joana Sousa',
			:address => 'Avenida da Boavista, 552',
			...
			:address => 'Rua do São Martinho, 321',
			...
			:address => 'Rua de Teixeira Pascoães, 924',
			...
			:address => 'Rua da Fonte da Moura, 127',
			...
			:address => 'Rua de Pedro Hispano, 356',
			:birthdate => '12/17/1967',
			:gender => 'male',
